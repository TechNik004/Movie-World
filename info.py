...
PICS = (environ.get('PICS', 'https://envs.sh/e4E.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002322067375'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002156393297').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002156393297') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002238709293')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002222558126')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://technik659:8pZAv0q1E4TpzBfW@cluster0.scjdsho.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/FLiMPROVIDER')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://existing-juline-trexowner-ed1c17ec.koyeb.app/")
